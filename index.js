...
server.post('/drone-test/triangle', triangle_func );
server.post('/drone-test/flip', flip_func );
...
function flip_func(req, res, next){
    temporal.queue([
        {
            delay: 1000,
            task:   function(){
        ...
        },
        {
            delay: 2000,
            task:   function(){
                droneClient.post(api_path + '/frontFlip', {},
                    function(e,rq,rs,ob){
                        log_client_res(e,rq,rs,ob);
                });
            }
        ...
        },
        {
            delay: 2000,
            task:   function(){
                droneClient.post(api_path + '/backFlip', {},
                    function(e,rq,rs,ob){
                        log_client_res(e,rq,rs,ob);
                });
            }
...
function triangle_func(req, res, next){
    temporal.queue([
        {
            delay: 1000,
            task:   function(){
        ...
        },
        {
            delay: 2000,
            task:   function(){
                droneClient.post(api_path + '/turnRight', {speed:40,steps:7},
                    function(e,rq,rs,ob){
                        log_client_res(e,rq,rs,ob);
                });
        ...
        },
        {
            delay: 2000,
            task:   function(){
                droneClient.post(api_path + '/turnLeft', {speed:40,steps:14},
                    function(e,rq,rs,ob){
                        log_client_res(e,rq,rs,ob);
                });
